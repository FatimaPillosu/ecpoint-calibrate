...
[![coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/FatimaPillosu/ecpoint-calibrate/main/.github/badges/coverage.json)](https://github.com/FatimaPillosu/ecpoint-calibrate/actions/workflows/coverage.yml) [![license](https://img.shields.io/github/license/FatimaPillosu/ecpoint-calibrate?color=orange)](https://github.com/FatimaPillosu/ecpoint-calibrate/blob/main/LICENSE) [![release](https://img.shields.io/github/v/tag/FatimaPillosu/ecpoint-calibrate?sort=semver&color=8e44ad&label=release)](https://github.com/FatimaPillosu/ecpoint-calibrate/releases/latest) [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20515532.svg)](https://doi.org/10.5281/zenodo.20515532)
...
Development was originally sponsored by the [ECMWF Summer of Weather Code (ESoWC)](https://github.com/ecmwf/ecpoint-calibrate) programme at [ECMWF](https://www.ecmwf.int).
