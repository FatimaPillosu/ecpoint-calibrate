    ...
    <Grid padded="horizontally">
      ...
      <Grid.Row centered columns={3}>
        <Grid.Column textAlign="left">
          <Button
            color="facebook"
            onClick={() => window.open('https://facebook.com/ESoWC', '_blank')}
          >
            <Icon name="facebook" />
            Facebook
          </Button>
        ...
        <Grid.Column textAlign="center">
          <Button
            color="twitter"
            onClick={() => window.open('https://twitter.com/esowc_ecmwf', '_blank')}
          >
            <Icon name="twitter" />
            Twitter
          </Button>
        ...
        <Grid.Column textAlign="right">
          <Button
            color="github"
            onClick={() =>
              window.open('https://github.com/esowc/ecPoint-Calibrate', '_blank')
            }
          >
            <Icon name="github" />
            GitHub
